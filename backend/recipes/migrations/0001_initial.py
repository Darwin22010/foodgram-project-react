...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        max_length=300, verbose_name="Название ингредиента"
                    ),
                ),
                (
                    "measurement_unit",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "image",
                    models.ImageField(
                        blank=True, upload_to="recipes/", verbose_name="Фотография"
                    ),
                ),
        ...
        migrations.AddField(
            ...
            name="tags",
            field=models.ManyToManyField(
                related_name="recipes", to="recipes.Tags", verbose_name="Теги"
            ),
        ),
        migrations.AddField(
